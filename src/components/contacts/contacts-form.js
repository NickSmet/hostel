...
class ContactsForm extends React.Component {
  ...
  handleSubmit = () => {
    if (this.state.name === '' || this.state.email === '') {
      ...
      axios.post('http://centeral.ru/php/sendMessage.php', {
    ...
    return (
      <div className="contacts-form-wrapper">
        ...
        <div onClick={() => this.handleSubmit()}>
          <Button
            additionalClass={'contacts-form'}
            title={this.props.lang.send}
          />
        </div>
        ...
        {this.props.language === 'ru' ? (
          <div>
            <Alert
              bsStyle="danger"
              className={
                this.state.showAlert ? 'form-alert active' : 'form-alert'
              }
            >
            ...
            <Alert
              bsStyle="success"
              className={this.state.showOk ? 'form-alert active' : 'form-alert'}
            >
              Отправлено
            </Alert>
          </div>
