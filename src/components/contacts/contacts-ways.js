                        ...
                        >
                            <Panel id="contacts-way-svo" bsClass='contacts-way' key='1' eventKey="1" >
                                ...
                                <Panel.Collapse>
                                    <Panel.Body>
                                        <p>
                                            Aeroexpress will bring you to Belorussky railway station (Белорусский вокзал), 
                                            where you should switch to Belorusskaya metro station (dark green line).
                                        </p>
                                        <img src="http://dev.centeral.ru/img/svo_1.png" alt="Путь от Шереметьево"/>
                                        <p>
                                            From there you should go 3 stops to Teatralnaya station. 
                                            Exit the station towards Teatralnaya Square (Театральная Площадь) and follow the map.
                                        </p>
                                        <img src="http://dev.centeral.ru/img/svo_2.png" alt="Путь от Шереметьево"/>
                                    </Panel.Body>
                                </Panel.Collapse>
                            ...
                            <Panel id="contacts-way-dme" bsClass='contacts-way' key='2' eventKey="2">
                                ...
                                <Panel.Collapse>
                                    <Panel.Body>
                                        <p>
                                            Aeroexpress will bring you to Paveletskiy railway station (Павелецкий вокзал),
                                             where you should switch to Paveletskaya metro station (dark green line).
                                        </p>
                                        <img src="http://dev.centeral.ru/img/dme_1.jpg" alt="Путь от Домодедово"/>
                                        <p>
                                            From there you should go 3 stops to Teatralnaya station. 
                            ...
                            <Panel id="contacts-way-vko" bsClass='contacts-way' key='3' eventKey="3">
                                ...
                                <Panel.Collapse>
                                    <Panel.Body>
                                        <p>
                                            Aeroexpress will bring you to Kievskiy railway station (Киевский вокзал), 
                                            where you should switch to Kiyevskaya metro station (dark blue line).
                                        </p>
                                        <img src="http://dev.centeral.ru/img/vko_1.jpg" alt="Путь от Внуково"/>
                                        <p>
                                            From Kievskaya you should go 3 stops to Ploshchad Revolyutsii station. 
                                            Exit the station towards Ploshchad Revolyutsii (Площадь Революции) and follow the map.
                                        </p>
                                        <img src="http://dev.centeral.ru/img/vko_2.png" alt="Путь от Внуково"/>
                                    </Panel.Body>
                                </Panel.Collapse>
